...
tl.fromTo("#greentruck", 15, { x: 0, transformOrigin: "50% 50%" }, { x: 1100, transformOrigin: "50% 50%", ease: Expo.easeInOut });
...
TweenMax.fromTo("#Mixer", 10, { x: 500, transformOrigin: "50% 50%" }, { x: -500, transformOrigin: "50% 50%", ease: Sine.easeInOut, repeat: -1, yoyo: true });
